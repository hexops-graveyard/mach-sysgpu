...
pub const CommandEncoder = opaque {
    ...
    pub inline fn copyBufferToBuffer(
        ...
        Impl.commandEncoderCopyBufferToBuffer(
            command_encoder,
            source,
            source_offset,
            destination,
    ...
    pub inline fn finish(command_encoder: *CommandEncoder, descriptor: CommandBuffer.Descriptor) *CommandBuffer {
        return Impl.commandEncoderFinish(command_encoder, descriptor);
    }

    pub inline fn injectValidationError(command_encoder: *CommandEncoder, message: []const u8) void {
    ...
    pub inline fn resolveQuerySet(
        ...
        Impl.commandEncoderResolveQuerySet(
            command_encoder,
            query_set,
            first_query,
            query_count,
